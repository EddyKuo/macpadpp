...
[English](windows_sa_sd.md) · **繁體中文**

> **上游**：[`windows_prd.zh-TW.md`](windows_prd.zh-TW.md)、[`windows_srs.zh-TW.md`](windows_srs.zh-TW.md)
...
4. windeployqt --release（保留 translations）macpad++.exe
...
---
*下游：詳細設計見 [`windows_design.zh-TW.md`](windows_design.zh-TW.md)（逐檔 diff 級別的實作設計）。*
