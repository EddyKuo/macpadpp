...
[English](windows_srs.md) · **繁體中文**

> **上游**：[`docs/windows_prd.zh-TW.md`](windows_prd.zh-TW.md)（PRD v1.0.0）
...
---
*下游：SA/SD（[`windows_sa_sd.zh-TW.md`](windows_sa_sd.zh-TW.md)）依本 SRS 定義架構與模組分工。*
